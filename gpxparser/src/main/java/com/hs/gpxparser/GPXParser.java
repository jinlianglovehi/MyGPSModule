...
public class GPXParser extends BaseGPX {
	...
	/**
	 *  简单的解析 gps的描述的文本信息和 metadata的数据信息
	 *
	 * @param inputStream
	 * @return
     */
	public GPX parseSimpleGPX(InputStream inputStream)  throws Exception{
		DocumentBuilder builder = DocumentBuilderFactory.newInstance().newDocumentBuilder();
